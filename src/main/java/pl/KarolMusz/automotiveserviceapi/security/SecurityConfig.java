    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors()
            ...
            .authorizeRequests()
                ...
                .antMatchers(HttpMethod.POST, "/users/new/client").permitAll()
                .antMatchers(HttpMethod.GET, "/about").permitAll()
                .antMatchers(HttpMethod.POST, "/users/new/admin").hasAuthority(Role.ADMIN.toString())
                ...
                .antMatchers(HttpMethod.POST, "/users/vehicle")
                    .hasAuthority(Role.CLIENT.toString())
                .antMatchers(HttpMethod.DELETE, "/users/vehicle/{vehicle-vin}")
                    .hasAuthority(Role.CLIENT.toString())
